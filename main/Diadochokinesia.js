...
console.log('Running diadochokinesia recording for palm (position, velocity & vector) and finger (position, velocity & vector)');

var now = new Date();
var dhour = now.getHours();
var dminute = now.getMinutes();

var palm_pos_stream=fs.createWriteStream('Diadochokinesia_palm_position_'+dhour+dminute+'hrs.csv',{flags:'w'});
var palm_velocity_stream=fs.createWriteStream('Diadochokinesia_palm_velocity_'+dhour+dminute+'hrs.csv',{flags:'w'});
//var finger_pos_stream = fs.createWriteStream('Diadochokinesia_finger_position_'+dhour+dminute+'hrs.csv', {flags : 'w'});
//var finger_velocity_stream = fs.createWriteStream('Diadochokinesia_finger_velocity_'+dhour+dminute+'hrs.csv', {flags : 'w'});
var palm_rot_stream=fs.createWriteStream('Diadochokinesia_palm_rotation_'+dhour+dminute+'hrs.csv',{flags:'w'});
...
//              finger_pos_stream.write("HandID: "+handid+"\t"+"FingerID: "+fingerid+"\t"+"Finger_Position: "+JSON.stringify(fgs)+"\t");
//              finger_velocity_stream.write("HandID: "+handid+"\t"+"FingerID: "+fingerid+"\t"+"Finger_Velocity: "+JSON.stringify(fv)+"\t");
              }//end finger loop

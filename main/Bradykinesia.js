...
console.log('Running bradykinesia for palm (position, velocity & vector) and finger (position, velocity & vector)');

var now = new Date();
var dhour = now.getHours();
var dminute = now.getMinutes();

var palm_pos_stream=fs.createWriteStream('Bradykinesia_palm_position_'+dhour+dminute+'hrs.csv',{flags:'w'});
var palm_velocity_stream=fs.createWriteStream('Bradykinesia_palm_velocity_'+dhour+dminute+'hrs.csv',{flags:'w'});
var finger_pos_stream = fs.createWriteStream('Bradykinesia_finger_position_'+dhour+dminute+'hrs.csv', {flags : 'w'});
var finger_velocity_stream = fs.createWriteStream('Bradykinesia_finger_velocity_'+dhour+dminute+'hrs.csv', {flags : 'w'});
var palm_direction_stream=fs.createWriteStream('Bradykinesia_palm_direction_'+dhour+dminute+'hrs.csv',{flags:'w'}); //// new line
var finger_vector_stream = fs.createWriteStream('Bradykinesia_finger_vector_'+dhour+dminute+'hrs.csv', {flags : 'w'}); //// new line
// var palm_rot_stream=fs.createWriteStream('Bradykinesia_palm_rotation_'+dhour+dminute+'hrs.csv',{flags:'w'});
...
controller.on("frame", function(frame) {
              ...
              palm_direction_stream.write("Timestamp: "+"\t"+(frame.timestamp)/1000000 + "\t"); //// new variable
...
//              prevRot=pr;
              ...
              var pvector = hand.palmNormal; //// new variable
              ...
              palm_direction_stream.write("HandID: "+handid+"\t"+"Palm_Direction: "+JSON.stringify(pvector)+"\t"); //// new variable
              ...
              console.log("HandID_FingerID: "+handid+fingerid+"x: " + fgs[0] + "y: " + fgs[1] + "z: " + fgs[2]);

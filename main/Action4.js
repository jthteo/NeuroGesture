...
var palm_pos_stream=fs.createWriteStream('Action4_palm_position_'+dhour+dminute+'hrs.csv',{flags:'w'});
var palm_velocity_stream=fs.createWriteStream('Action4_palm_velocity_'+dhour+dminute+'hrs.csv',{flags:'w'});
var finger_pos_stream = fs.createWriteStream('Action4_finger_position_'+dhour+dminute+'hrs.csv', {flags : 'w'});
var finger_velocity_stream = fs.createWriteStream('Action4_finger_velocity_'+dhour+dminute+'hrs.csv', {flags : 'w'});
var finger_vector_stream = fs.createWriteStream('Action4_finger_vector_'+dhour+dminute+'hrs.csv', {flags : 'w'}); //// new line

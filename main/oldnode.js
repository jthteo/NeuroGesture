...
var palm_pos_stream=fs.createWriteStream('Generic_palm_position.csv',{flags:'w'});
var palm_velocity_stream=fs.createWriteStream('Generic_palm_velocity.csv',{flags:'w'});
var finger_pos_stream = fs.createWriteStream('Generic_finger_position.csv', {flags : 'w'});
var finger_velocity_stream = fs.createWriteStream('Generic_finger_velocity.csv', {flags : 'w'});
var palm_rot_stream=fs.createWriteStream('Generic_palm_rotation.csv',{flags:'w'});
